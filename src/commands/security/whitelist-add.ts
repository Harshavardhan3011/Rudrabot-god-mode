/**
 * WHITELIST-ADD - Security Command #45
 */
...
export const name = 'whitelist-add';
export const description = 'Add to whitelist';
...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  try {
    const embed = new EmbedBuilder()
      .setColor('#FF0000')
      .setTitle('🛡️ Whitelist add')
      .setDescription('Security command #45')
      .addFields(
