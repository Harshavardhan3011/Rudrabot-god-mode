/**
 * WHITELIST-ROLE - Security Command #48
 */
...
export const name = 'whitelist-role';
export const description = 'Whitelist a role';
...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  try {
    const embed = new EmbedBuilder()
      .setColor('#FF0000')
      .setTitle('🛡️ Whitelist role')
      .setDescription('Security command #48')
      .addFields(
